...
spark.sql(f"CREATE SCHEMA IF NOT EXISTS bronze MANAGED LOCATION 'abfss://riot-data@{storage_account}.dfs.core.windows.net/delta/bronze'")
...
spark.read.table("bronze.tft_match_details").display()